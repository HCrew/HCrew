...
class DisciplinaOfertada(models.Model):
    ...
    id_coordenador_disciplina_ofertada = models.ForeignKey(
        Coordenador, models.DO_NOTHING, db_column='id_coordenador_disciplina_ofertada'
    )
    ...
    id_professor_disciplina_ofertada = models.ForeignKey(
        Professor, models.DO_NOTHING, db_column='id_professor_disciplina_ofertada', blank=True, null=True
    )
    ...
    class Meta:
        ...
        unique_together = ((
            'id_disciplina_disciplina_ofertada', 'id_curso_disciplina_ofertada', 
            'ano_disciplina_ofertada', 'semestre_disciplina_ofertada', 'turma_disciplina_ofertada'
        ),)
