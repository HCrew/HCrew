...
class Entrega(models.Model):
    ...
    id_aluno_entrega = models.ForeignKey(
        Aluno, models.DO_NOTHING, db_column='id_aluno_entrega'
    )
    id_atividade_vinculada_entrega = models.ForeignKey(
        AtividadeVinculada, models.DO_NOTHING, db_column='id_atividade_vinculada_entrega'
    )
    ...
    id_professor_entrega = models.ForeignKey(
        Professor, models.DO_NOTHING, db_column='id_professor_entrega', blank=True, null=True
    )
